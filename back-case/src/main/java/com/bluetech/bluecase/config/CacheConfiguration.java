package com.bluetech.bluecase.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.bluetech.bluecase.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.bluetech.bluecase.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.bluetech.bluecase.domain.User.class.getName());
